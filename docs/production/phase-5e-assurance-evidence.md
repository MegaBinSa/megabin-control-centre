...
**Status:** Recovery, alert-delivery, component-rollback and isolated forward-repair rehearsals Passed; UAT-OFF-001, UAT-DRV-001 and UAT-WEB-001 Passed and three synthetic UAT journeys remain
...
| Six synthetic UAT journeys | In progress | `UAT-OFF-001`, `UAT-DRV-001` and `UAT-WEB-001` Passed with release-bound evidence; three journeys remain Not Run |
