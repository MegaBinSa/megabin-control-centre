...
| Synthetic Internal UAT Passed | Not Run | Four of six journeys have Passed with release-bound evidence | `UAT-OFF-001`, `UAT-DRV-001`, `UAT-WEB-001` and `UAT-SKP-001` Passed; execute/sign off `UAT-FIN-001` and `UAT-TRK-001` |
...
- **Passed journeys:** `UAT-OFF-001` Office planning and operational observation; `UAT-DRV-001` Driver execution/offline synchronization and authorization isolation; `UAT-WEB-001` protected Website intake, durable processing, review/approval and atomic authority transition; `UAT-SKP-001` authenticated inbound SKIP, one-occurrence exclusion, capture-only acknowledgement and immutable-source Draft replanning.
- **Not Run:** `UAT-FIN-001` and `UAT-TRK-001`; the aggregate UAT Passed gate is therefore not achieved.
