...
**Status:** Ready; all six journeys remain Not Run pending post-merge protected execution

| Case | Journey | Result | Evidence/blocker |
|---|---|---|---|
| `UAT-OFF-001` | Office operational planning | Not Run | Protected execution and operator evidence required |
